...
#
class AI Agent::Document < ApplicationRecord
  class LimitExceededError < StandardError; end
  self.table_name = 'aiagent_documents'

  belongs_to :assistant, class_name: 'AI Agent::Assistant'
  has_many :responses, class_name: 'AI Agent::AssistantResponse', dependent: :destroy, as: :documentable
  belongs_to :account
  ...
  def enqueue_crawl_job
    ...
    AI Agent::Documents::CrawlJob.perform_later(self)
  end

  def enqueue_response_builder_job
    return if status != 'available'

    AI Agent::Documents::ResponseBuilderJob.perform_later(self)
  end
