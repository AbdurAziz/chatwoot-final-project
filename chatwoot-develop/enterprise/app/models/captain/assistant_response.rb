...
#
class AI Agent::AssistantResponse < ApplicationRecord
  ...
  def self.search(query)
    embedding = AI Agent::Llm::EmbeddingService.new.get_embedding(query)
  ...
  def update_response_embedding
    ...
    AI Agent::Llm::UpdateEmbeddingJob.perform_later(self, "#{question}: #{answer}")
  end
end
