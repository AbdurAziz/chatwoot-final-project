class AI Agent::Llm::ConversationFaqService < Llm::BaseOpenAiService
  ...
  def find_and_separate_duplicates(faqs)
    ...
    faqs.each do |faq|
      ...
      embedding = AI Agent::Llm::EmbeddingService.new.get_embedding(combined_text)
  ...
  def chat_parameters
    ...
    prompt = AI Agent::Llm::SystemPromptsService.conversation_faq_generator(account_language)
