...
class AI Agent::Copilot::ChatService < Llm::BaseOpenAiService
  ...
  def register_tools
    @tool_registry = AI Agent::ToolRegistryService.new(@topic, user: @user)
  ...
  def system_message
    {
      role: 'system',
      content: AI Agent::Llm::SystemPromptsService.copilot_response_generator(@topic.config['product_name'])
    }
  end
