class Api::V1::Accounts::AI Agent::AssistantsController < Api::V1::Accounts::BaseController
  before_action :current_account
  before_action -> { check_authorization(AI Agent::Assistant) }
  ...
  def account_assistants
    @account_assistants ||= AI Agent::Assistant.for_account(Current.account.id)
  end
