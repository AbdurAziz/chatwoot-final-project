class Api::V1::Accounts::AI Agent::TopicsController < Api::V1::Accounts::BaseController
  before_action :current_account
  before_action -> { check_authorization(AI Agent::Topic) }
  ...
  def playground
    response = AI Agent::Llm::TopicChatService.new(topic: @topic).generate_response(
  ...
  def account_topics
    @account_topics ||= AI Agent::Topic.for_account(Current.account.id)
  end
