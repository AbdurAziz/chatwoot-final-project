...
RSpec.describe 'Api::V1::Accounts::AI Agent::Documents', type: :request do
    ...
    context 'when it is an admin' do
      context 'with valid parameters' do
        it 'creates a new document' do
          ...
          end.to change(AI Agent::Document, :count).by(1)
        end
      ...
      context 'with limits exceeded' do
        before do
          ...
          create(:installation_config, name: 'CAPTAIN_CLOUD_PLAN_LIMITS', value: aiagent_limits.to_json)
          post "/api/v1/accounts/#{account.id}/aiagent/documents",
               params: valid_attributes,
               headers: admin.create_new_auth_token
        end
