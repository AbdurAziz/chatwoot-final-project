...
RSpec.describe 'Api::V1::Accounts::AI Agent::Topics', type: :request do
      ...
      it 'creates a new topic' do
        expect do
          post "/api/v1/accounts/#{account.id}/aiagent/topics",
               ...
               as: :json
        end.to change(AI Agent::Topic, :count).by(1)
  ...
  describe 'POST /api/v1/accounts/{account.id}/aiagent/topics/{id}/playground' do
    ...
    context 'when it is an agent' do
      it 'generates a response' do
        chat_service = instance_double(AI Agent::Llm::TopicChatService)
        allow(AI Agent::Llm::TopicChatService).to receive(:new).with(topic: topic).and_return(chat_service)
