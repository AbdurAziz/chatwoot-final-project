...
RSpec.describe AI Agent::Tools::SimplePageCrawlParserJob, type: :job do
  describe '#perform' do
    ...
    let(:crawler) { instance_double(AI Agent::Tools::SimplePageCrawlService) }

    before do
      allow(AI Agent::Tools::SimplePageCrawlService).to receive(:new)
        .with(page_link)
        .and_return(crawler)
